...
/usr/libexec/PlistBuddy -c "Set :DevicePreferences:$UITEST_IOSDEVICE_ID:ConnectHardwareKeyboard NO" ~/Library/Preferences/com.apple.iphonesimulator.plist || true
